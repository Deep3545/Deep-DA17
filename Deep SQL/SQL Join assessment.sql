...
SELECT
    ...
    SUM(o.quantity * o.amount) / COUNT(DISTINCT o.order_id) AS Average_Order_Value
FROM Customers2 c
INNER JOIN Orders o
    ON c.customer_id = o.customer_id
GROUP BY c.city
HAVING SUM(o.quantity * o.amount) > 100000
...
SELECT
    ...
    SUM(o.quantity * o.amount) AS Total_Purchase_Value,
    MAX(o.quantity * o.amount) AS Highest_Transaction_Value
FROM Customers2 c
INNER JOIN Orders o
    ON c.customer_id = o.customer_id
GROUP BY
    ...
    c.city
HAVING
    MAX(o.quantity * o.amount) > 25000
    AND SUM(o.quantity * o.amount) > 50000
...
SELECT
    ...
    AVG(o.quantity * o.amount) AS Average_Order_Amount,
