...
INSERT INTO Customers4 VALUES (1, 'Aarav Mehta', 'Ahmedabad', 'Gujarat', '2025-01-15', 'Enterprise');
INSERT INTO Customers4 VALUES (2, 'Diya Shah', 'Mumbai', 'Maharashtra', '2025-01-20', 'Premium');
INSERT INTO Customers4 VALUES (3, 'Rohan Patel', 'Ahmedabad', 'Gujarat', '2025-02-03', 'Standard');
INSERT INTO Customers4 VALUES (4, 'Ananya Iyer', 'Bengaluru', 'Karnataka', '2025-02-10', 'Premium');
INSERT INTO Customers4 VALUES (5, 'Kabir Joshi', 'Pune', 'Maharashtra', '2025-02-18', 'Standard');
INSERT INTO Customers4 VALUES (6, 'Meera Desai', 'Surat', 'Gujarat', '2025-03-01', 'Premium');
INSERT INTO Customers4 VALUES (7, 'Vivaan Kapoor', 'Delhi', 'Delhi', '2025-03-08', 'Enterprise');
INSERT INTO Customers4 VALUES (8, 'Ishita Rao', 'Hyderabad', 'Telangana', '2025-03-15', 'Standard');
INSERT INTO Customers4 VALUES (9, 'Aditya Singh', 'Jaipur', 'Rajasthan', '2025-03-21', 'Premium');
INSERT INTO Customers4 VALUES (10, 'Sara Khan', 'Lucknow', 'Uttar Pradesh', '2025-04-02', 'Standard');
INSERT INTO Customers4 VALUES (11, 'Arjun Verma', 'Noida', 'Uttar Pradesh', '2025-04-11', 'Enterprise');
INSERT INTO Customers4 VALUES (12, 'Nisha Shah', 'Vadodara', 'Gujarat', '2025-04-18', 'Premium');
INSERT INTO Customers4 VALUES (13, 'Kunal Shah', 'Rajkot', 'Gujarat', '2025-05-03', 'Standard');
INSERT INTO Customers4 VALUES (14, 'Tanya Malhotra', 'Chandigarh', 'Chandigarh', '2025-05-14', 'Premium');
INSERT INTO Customers4 VALUES (15, 'Dev Agarwal', 'Indore', 'Madhya Pradesh', '2025-05-22', 'Standard');
INSERT INTO Customers4 VALUES (16, 'Pooja Nair', 'Kochi', 'Kerala', '2025-06-05', 'Premium');
INSERT INTO Customers4 VALUES (17, 'Manav Gupta', 'Gurugram', 'Haryana', '2025-06-17', 'Enterprise');
INSERT INTO Customers4 VALUES (18, 'Riya Kulkarni', 'Nashik', 'Maharashtra', '2025-06-25', 'Standard');
INSERT INTO Customers4 VALUES (19, 'Yash Trivedi', 'Ahmedabad', 'Gujarat', '2025-07-03', 'Premium');
INSERT INTO Customers4 VALUES (20, 'Sneha Menon', 'Chennai', 'Tamil Nadu', '2025-07-12', 'Standard');
INSERT INTO Customers4 VALUES (21, 'Rahul Bansal', 'Bhopal', 'Madhya Pradesh', '2025-07-21', 'Premium');
INSERT INTO Customers4 VALUES (22, 'Aisha Sheikh', 'Mumbai', 'Maharashtra', '2025-08-02', 'Standard');
INSERT INTO Customers4 VALUES (23, 'Harsh Vora', 'Ahmedabad', 'Gujarat', '2025-08-16', 'Enterprise');
INSERT INTO Customers4 VALUES (24, 'Neha Soni', 'Udaipur', 'Rajasthan', '2025-08-25', 'Standard');
INSERT INTO Customers4 VALUES (25, 'Om Prakash', 'Patna', 'Bihar', '2025-09-04', 'Premium');
INSERT INTO Customers4 VALUES (26, 'Mahi Jain', 'Kolkata', 'West Bengal', '2025-09-13', 'Standard');
INSERT INTO Customers4 VALUES (27, 'Siddharth Roy', 'Bengaluru', 'Karnataka', '2025-09-20', 'Enterprise');
INSERT INTO Customers4 VALUES (28, 'Palak Mehta', 'Surat', 'Gujarat', '2025-10-01', 'Standard');
INSERT INTO Customers4 VALUES (29, 'Atharv Shah', 'Vadodara', 'Gujarat', '2025-10-12', 'Premium');
INSERT INTO Customers4 VALUES (30, 'Kiara Patel', 'Pune', 'Maharashtra', '2025-10-19', 'Standard');
...
SELECT
    ...
    WHERE
    state = 'Gujarat' OR
    customer_segment = 'Premium'  AND customer_segment = 'Enterprise';
    

--3)
SELECT * from Products
WHERE
    unit_price between 5000 and 20000
...
WHERE e.designation LIKE 'Sales%'
GROUP BY 
    e.employee_name,
    e.department_id
...
SELECT
   p.product_id,
   p.product_name,
   SUM(o.quantity,0) AS total-quantity_sold,
FROM Products p
LEFT JOIN orders o
ON p.product_id = o.product_id
GROUP BY 
...
SELECT 
    c.customer_id,
    c.customer_name,
    SUM(o.quantity * p.unit_price) AS total_completed_order_value
FROM Customers4 c
INNER JOIN Orders o
    ON c.customer_id = o.customer_id
INNER JOIN Products p
...
SELECT TOP 5
    c.customer_name,
    SUM(o.quantity * p.unit_price) AS completed_order_revenue
FROM Customers4 c
INNER JOIN Orders o
    ON c.customer_id = o.customer_id
INNER JOIN Products p
...
SELECT 
    e.employee_id,
    e.employee_name,
    SUM(o.quantity * p.selling_price) AS completed_order_revenue
FROM Employees e
JOIN Orders o 
    ON e.employee_id = o.sales_employee_id
JOIN Products p
...
HAVING SUM(o.quantity * p.selling_price) > 500000;
...
SELECT 
    c.city,
    SUM(s.sale_amount) AS total_completed_sales
FROM sales AS s
INNER JOIN Customers4 AS c
...
/*SELECT
    c.city,
    SUM(o.sale_amount) AS total_completed_sales
FROM Orders o
JOIN Customers4 c
    ON o.customer_id = c.customer_id
WHERE o.order_status = 'Completed'
GROUP BY c.city
HAVING SUM(o.sale_amount) > 300000
ORDER BY total_completed_sales DESC;*/

--36)
SELECT
    o.customer_id AS order_customer_id,
    st.customer_id AS ticket_customer_id,
    c.customer_name,
    o.order_id,
    st.ticket_id
FROM Orders o
...
FULL OUTER JOIN Customers c
    ON c.customer_id = o.customer_id
    OR c.customer_id = st.customer_id
...
/*SELECT
    c.customer_id,
    c.customer_name,
    COUNT(DISTINCT o.product_name) AS different_products
FROM Customers4 c
JOIN Orders o
    ON c.customer_id = o.customer_id
GROUP BY
    c.customer_id,
    c.customer_name
HAVING COUNT(DISTINCT o.product_name) >= 3
